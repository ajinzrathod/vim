...
inoremap Sys<Tab> System.out.println();<Esc>hi""<Esc>i
inoremap PSVM<Tab> public static void main(String[] args){<CR>}<Esc>ko
inoremap FOR<Tab> for(int i = 0; i < n; i++){<CR>}<Esc>ko
